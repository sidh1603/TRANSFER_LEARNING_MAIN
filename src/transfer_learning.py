...
def main(config_path):
    ...
    base_model_path = os.path.join("artifacts","models","basemodel.h5")
...
new_model.compile(loss="sparse_categorical_crossentropy",optimizer=tf.keras.optimizers.SGD(learning_rate=1e-3),metrics=["accuracy"])
